...
test.describe('QuestionList e2e tests', () => {
    ...
    test('should contain all question items present in localStorage', async ({ page }) => {
        // when
    ...
    test('should be able to drag and drop questions down in QuestionList', async () => {
        ...
        // when
        await questionListPage.dragAndDropQuestion(questionsBefore[0], questionsBefore[1]);
    ...
    test('should be able to drag and drop questions up in QuestionList', async () => {
        ...
        // when
        await questionListPage.dragAndDropQuestion(questionsBefore[1], questionsBefore[0]);

        // then
        await verifyOrderChanged(questionsBefore);
    });

    test('should be able to reorder question down in QuestionList with keyboard shortcuts', async ({ page }) => {
        // given
        const questionsBefore = await questionListPage.preloadQuestionData();
    ...
    test('should be able to reorder question up in QuestionList with keyboard shortcuts', async ({ page }) => {
        // given
        const questionsBefore = await questionListPage.preloadQuestionData();
    ...
    test('should NOT be able to reorder the first question UP in QuestionList with keyboard shortcuts', async ({ page }) => {
        // given
        const questionsBefore = await questionListPage.preloadQuestionData();
        const questionItemPage = new QuestionItemPage(page, questionsBefore[0].id);
    ...
    test('should NOT be able to reorder the last question DOWN in QuestionList with keyboard shortcuts', async ({ page }) => {
        // given
        const questionsBefore = await questionListPage.preloadQuestionData();
