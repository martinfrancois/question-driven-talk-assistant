...
export class QRCodeComponentPage extends AppPage {
    ...
    constructor(page: Page) {
        ...
        this.resizeHandleBottomRight = page.getByTestId('qr-code-resize-bottom-right');
        this.resizeHandleBottomLeft = page.getByTestId('qr-code-resize-bottom-left');
    ...
    async resizeQRCode(direction: 'bottom-right' | 'bottom-left') {
        const handle = direction === 'bottom-right' ? this.resizeHandleBottomRight : this.resizeHandleBottomLeft;
